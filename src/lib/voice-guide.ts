...
type StepKey =
  ...
  | "done_success"
  | "done_failed"
  // Re-verify specific steps
  | "reverify_idle"
  | "reverify_search"
  | "reverify_face_scan"
  | "reverify_loading_url"
  | "reverify_link"
  | "reverify_checking"
  | "reverify_submitting"
  | "reverify_done_success"
  | "reverify_done_failed";

const SCRIPTS: Record<StepKey, string> = {
  idle:
    "হ্যালো! প্রথমে যার মুখ দিয়ে ভেরিফাই করবেন, তার নাম লিখুন। তারপর নিচের রঙিন বড় বাটন, ফেস ভেরিফিকেশন শুরু করুন, এই লেখায় একবার ক্লিক করুন!",
  ...
  reverify_idle:
    "রি-ভেরিফাই করতে নিচের কমলা রঙের বাটনে ক্লিক করুন।",
  reverify_search:
    "এবার যে নামে আগে সেভ করেছিলেন, সেই নাম লিখে সার্চ করুন। নাম মনে না থাকলে নিচে ফেস স্ক্যান অপশনে ক্লিক করে ক্যামেরা দিয়ে মুখ দেখান, আমি নিজেই খুঁজে দেবো!",
  reverify_face_scan:
    "ক্যামেরার দিকে সোজা তাকান। মুখ ভালো আলোতে রাখুন, ছবি তোলার পর আপনার সেভ করা ফেসগুলোর সাথে মিলিয়ে নেবো।",
  reverify_loading_url:
    "একটু অপেক্ষা করুন, ভেরিফাই লিঙ্ক তৈরি হচ্ছে।",
  reverify_link:
    "এবার, ফেস ভেরিফিকেশন খুলুন, বাটনে ক্লিক করুন। গুড ডলার সাইটে ফেস স্ক্যান শেষ করে এই অ্যাপে ফিরে আসুন, অটোমেটিক চেক হবে!",
  reverify_checking: "অপেক্ষা করুন, হোয়াইটলিস্ট চেক হচ্ছে।",
  reverify_submitting: "প্রায় শেষ! অ্যাকাউন্ট কমপ্লিট হচ্ছে।",
  reverify_done_success:
    "অভিনন্দন! রি-ভেরিফাই সফল! আপনার ব্যালেন্সে টাকা যোগ হয়ে গেছে!",
  reverify_done_failed:
    "ইশ! এবার হয়নি। চিন্তা করবেন না, আবার চেষ্টা করুন!",
};
