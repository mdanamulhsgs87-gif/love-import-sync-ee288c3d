                ...
                {loginStep === "phone" && (
                  <form onSubmit={handleLoginStep1} className="space-y-3.5">
                    ...
                    <motion.button type="button" whileTap={{ scale: 0.95 }}
                      ...
                      className="w-full py-3.5 rounded-2xl border border-border/50 bg-secondary/50 hover:bg-secondary font-bold text-sm flex items-center justify-center gap-3 transition-all">
